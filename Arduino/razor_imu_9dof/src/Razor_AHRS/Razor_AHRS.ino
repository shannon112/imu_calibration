...
float magn_ellipsoid_center[3] = {490.381, -248.010, -261.578};
float magn_ellipsoid_transform[3][3] = {{0.971117, -0.0277113, -0.0425122}, {-0.0277113, 0.881974, 0.00831417}, {-0.0425122, 0.00831417, 0.911061}};
// Gyroscope
